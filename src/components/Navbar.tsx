...
const Navbar = () => {
  ...
  return (
    <>
      <div className={`${styles.navWrapper} ${scrolled ? styles.scrolled : ''} ${['/scholarship-program', '/universities', '/services', '/courses', '/about', '/news', '/blogs'].includes(pathname) && !scrolled ? styles.scholarshipNav : ''}`}>
